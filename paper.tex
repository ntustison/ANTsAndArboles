...
including (along with a brief description of each script):
\begin{itemize}
  ...
  \item {\tt createModel.R}:  creates random forest model given the input csv 
...
Two additional feature images are calculated which seem to aid in 
...
supplied training data.  Initial testing of our proposed framework was performed 
...
Additionally, the {\tt randomForest} package provides a couple measurements 
...
package with R provides tremendous potential for future insightful analyses 
