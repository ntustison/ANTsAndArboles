...
\title{Optimal Symmetric Multimodal Templates and Concatenated Random Forests for Supervised Brain Tumor Segmentation (Simplified) with ANTsR}
...
limitation, we localize our prior knowledge strategy through the 
...
ANTsR framework which coordinates all steps.
...
set of tools for multivariate neuroimage analysis.  
 ANTsR intends to provide a modern framework for medical analytics, 
