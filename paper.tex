...
\begin{figure}
  \centering
   \vspace{-15mm}
  \makebox[0.9\textwidth][c]{
    \includegraphics[width=150mm]{pipelineTestingTraining.pdf}
    }
...
are twelve GMM features for each of the four modalities ($n=48$), 
...
\begin{align}
\label{eq:mapmrf}
\mathrm{Tissue}\,\,\mathrm{classes} \sim \sum_{i \in MAP\_MRF} F_i + \sum_{i \in Asym} F_i + \sum_{i \in Misc} F_i,
\end{align}
