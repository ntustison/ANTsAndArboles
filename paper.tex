...
%  \includegraphics[width=20mm]{BRATS_HG0001/BRATS_HG0001_FLAIR_slice93.png} &
%  \includegraphics[width=20mm]{BRATS_HG0001/BRATS_HG0001_T1_slice93.png} &
%  \includegraphics[width=20mm]{BRATS_HG0001/BRATS_HG0001_T1C_slice93.png} &
%  \includegraphics[width=20mm]{BRATS_HG0001/BRATS_HG0001_T2_slice93.png} \\
  (a) & (b) &
  (c) & (d) \\
  \end{tabular}
...
\begin{figure}
  \centering
%    \includegraphics[width=80mm]{asymmetryFeatureImages.pdf}
...
\centering
  ...
  \includegraphics[width=150mm]{featureImages.pdf}
  }
...
\begin{figure}
  \centering
  \begin{tabular}{c}
%    \includegraphics[width=88mm]{pipeline2.pdf}
...
class.  These ``votes'' are converted to voxelwise probabilistic
estimates for each class.
\textcolor{red}{FIXME --- above comments need more detail ... how/why
  is this a probability, what does this mean?   it's bootstrapping etc
right so what can we say about this?}
The seven brain/tumor tissue types include:
\begin{itemize}
...
\paragraph{Stage 1 (Initial voxelwise classification)} 
...
\end{align}
given in the standard \textit{R} notation of \cite{wilkinson1973}.  The
...
from an individual subjects results in a set of
images estimating the spatial probabilities for each 
...
\begin{figure*}
  \vspace{-20mm}
  \makebox[\textwidth][c]{
  \includegraphics[width=140mm]{challengeResults.pdf}
  }
...
\begin{figure*}
  \makebox[\textwidth][c]{
  \begin{tabular}{cc}
  \includegraphics[width=90mm]{BRATS_HG_GMM.pdf} &
...
\begin{figure*}
  \makebox[\textwidth][c]{
  \begin{tabular}{cc}
  \includegraphics[width=90mm]{BRATS_LG_GMM.pdf} &
